...
(*.[0-9]*)
	...
	if test ! -f /home/luis/redox/redox/cookbook/recipes/ncurses/build/man_alias.sed ; then
cat >>/home/luis/redox/redox/cookbook/recipes/ncurses/build/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/luis/redox/redox/cookbook/recipes/ncurses/build/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/luis/redox/redox/cookbook/recipes/ncurses/build/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/luis/redox/redox/cookbook/recipes/ncurses/build/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/luis/redox/redox/cookbook/recipes/ncurses/build/man_alias.sed \
		< $i | sed -f /home/luis/redox/redox/cookbook/recipes/ncurses/build/edit_man.sed >$TMP
